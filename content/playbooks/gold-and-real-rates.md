...
{
  "order": 56,
  "slug": "gold-and-real-rates",
  "title": "Gold and real rates",
  "category": "cross-asset",
  "tier": 2,
  "reviewed": "28 August 2026",
  "summary": "Gold pays no income, so its main competition is the real yield on a government bond, and the relationship between the two explains more of gold's behaviour than inflation does even though inflation is the reason most people say they hold it.",
  "formula": "Why the comparison is with real yields\n  Gold pays        nothing\n  A bond pays      a nominal coupon\n  Real yield       roughly the nominal\n                   yield less expected\n                   inflation\n\n  Holding gold gives up the real yield.\n  That giving-up is its carrying cost.\n\nThe mechanism, stated plainly\n  Real yields up   the cost of holding\n                   gold rises\n  Real yields down the cost falls\n\n  So the two have tended to move in\n  opposite directions, and the sign of\n  that relationship is more reliable\n  than its size.\n\nWhere the real yield is published\n  The 10 year US Treasury inflation\n  protected yield, DFII10 at FRED.\n  A market price, not a forecast.\n\nWhat the relationship does NOT do\n  It does not predict a level.\n  It does not hold every quarter.\n  It has broken for years at a time\n  when something larger was moving\n  the price: a currency crisis, a\n  central bank buying programme, a\n  scramble for something outside the\n  banking system.",
  "failureModes": [
  ...
  "whenToUse": "Before adding gold to a portfolio, and whenever the case for holding it is being made loudly. The useful question is not whether inflation is coming but what the real yield is, because that is the number the holder is choosing to give up.",
  "sources": [
    {
      "name": "FRED, 10-year Treasury inflation-indexed security constant maturity (DFII10)",
      "url": "https://fred.stlouisfed.org/series/DFII10"
    },
    {
      "name": "FRED, 10-year breakeven inflation rate",
...
The number to watch is the ten-year inflation-protected Treasury yield, published as DFII10. It is worth pausing on why that series is the right one: it is a **market price for the real return on a safe asset**, not somebody's inflation forecast. The [chartbook](/chartbook/) carries it, alongside [breakeven inflation](/glossary/breakeven-inflation/), which is the market's implied expectation and a different quantity entirely. Confusing those two is the commonest error in this area, and [inflation and real returns](/playbooks/inflation-and-real-returns/) separates them properly.
...
That is not a flaw in the framework so much as its boundary, and knowing where a tool stops working is most of knowing how to use it. It is the same discipline as [where a framework breaks](/playbooks/reverse-the-assumption/): ask what would have to be true for this to be wrong, before relying on it.
