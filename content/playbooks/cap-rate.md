---
{
  "order": 40,
  "slug": "cap-rate",
  "title": "The capitalisation rate",
  "category": "property",
  "tier": 1,
  "calculator": "net-rental-yield",
  "reviewed": "27 August 2026",
  "summary": "A capitalisation rate is a property's net operating income divided by its price, which makes it a measure of what the building earns rather than what you earn, because it deliberately excludes your mortgage, your acquisition costs and your tax position.",
  "formula": "Net operating income\n  = Annual achieved rent\n  - Service charge\n  - Management fee\n  - Maintenance reserve\n  - Insurance and fixed costs\n  - Vacancy allowance\n  and nothing else: no mortgage, no depreciation, no tax\n\nCap rate\n  = Net operating income / Price\n\nThe same equation solved for price\n  Value = Net operating income / Cap rate\n\nWhat a change in the rate does to value, at unchanged income\n  Price change = (Old rate / New rate) - 1\n  6.0% to 7.0%  =  -14.3%\n  6.0% to 5.0%  =  +20.0%",
  "failureModes": [
  ...
  "whenToUse": "When ranking income producing properties against each other, and when testing what an asking price is assuming about the rent it needs to support. Not when working out what your own money will earn, which is cash on cash.",
  "sources": [
    {
...
Miss any one of those deductions and the rate you calculate is not comparable to anyone else's. Miss all of them and you have computed the [gross rental yield](/glossary/gross-rental-yield/) and given it a better name.

## The three numbers, and what each one answers

They are frequently used as synonyms. They are not.

| Number | Denominator | Includes debt | Answers |
|---|---|---|---|
| Gross yield | Price | No | What the listing wants you to see |
| Cap rate | Price | No | What the building earns |
