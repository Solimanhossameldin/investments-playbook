---
{
  ...
  "whenToUse": "Before treating a London gross yield and a Dubai gross yield as comparable numbers, which they are not. Also before assuming that a portfolio held entirely in a dollar pegged currency is diversified.",
  "sources": [
    {
      "name": "HMRC, Stamp Duty Land Tax residential rates",
      "url": "https://www.gov.uk/stamp-duty-land-tax/residential-property-rates"
    },
    {
      "name": "HMRC, Capital Gains Tax rates and allowances",
      "url": "https://www.gov.uk/capital-gains-tax/rates"
    },
    {
      "name": "HMRC, tax on UK rental income if you live abroad",
    ...
    {
      "name": "London rental yields by borough, 2026, indicative",
      "url": "https://investropa.com/blogs/news/london-rental-yields"
    }
  ]
}
---
