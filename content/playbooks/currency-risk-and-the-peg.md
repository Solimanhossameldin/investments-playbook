---
{
  ...
  "summary": "The dirham has been pegged to the US dollar at 3.6725 for decades, which means a Gulf resident holding dirham property, dirham salary and dollar denominated funds is not diversified across three currencies but concentrated in one, and the exposure only becomes visible when the money is eventually spent somewhere else.",
  ...
  "whenToUse": "Once, properly, when you have both a portfolio and a rough idea where you will end up. Then at any point that answer changes, which for most expatriates is more often than they expect.",
  "sources": [
    {
    ...
    {
      "name": "Bank for International Settlements, effective exchange rate statistics",
      "url": "https://www.bis.org/statistics/eer.htm"
    },
    {
      "name": "International Monetary Fund, exchange rate arrangements",
