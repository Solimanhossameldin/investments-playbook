---
{
  ...
  "summary": "Cash on cash return is the annual cash left after every running cost and every mortgage payment, divided by the cash you actually put in, and it is the only property return figure that answers what your own money earned.",
  ...
  "whenToUse": "On any leveraged purchase, alongside the net yield rather than instead of it. Check break even occupancy before you check the return.",
  "sources": [
    {
