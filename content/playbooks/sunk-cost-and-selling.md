---
{
  ...
  "summary": "The price paid for an asset has no bearing on whether to keep it, because that money is spent either way, and the only question that matters is whether the asset is the best use of the capital it currently ties up.",
  ...
  "whenToUse": "Annually on everything you own, and immediately whenever you catch yourself explaining a holding by reference to what you paid for it.",
  "sources": [
    {
