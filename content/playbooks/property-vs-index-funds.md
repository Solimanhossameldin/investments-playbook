---
{
  ...
  "whenToUse": "When the choice is being framed as which one returns more, which is the wrong question. Also before adding a second property to a portfolio that already holds one, where the concentration argument is at its strongest.",
  "sources": [
    {
      "name": "Dubai Land Department, fees and charges",
      "url": "https://dubailand.gov.ae/en/"
    },
    {
      "name": "IRS, estate tax for nonresidents not citizens of the United States",
    ...
    {
      "name": "Bank for International Settlements, property price statistics",
