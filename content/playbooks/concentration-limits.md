---
{
  ...
  "summary": "A concentration limit is a rule set in advance about how much of your net worth any single asset, building, tenant, employer or currency may represent, and its purpose is to make the decision while you are calm rather than while you are being persuaded.",
  ...
  "whenToUse": "Before the second property in the same building, which is where most concentration begins. Also as a standing annual review, because concentration accumulates without any single decision creating it.",
  "sources": [
    {
    ...
    {
      "name": "Dubai Land Department, transaction data",
