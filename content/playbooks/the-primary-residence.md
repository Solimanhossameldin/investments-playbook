---
{
  ...
  "summary": "A home you live in produces no income and cannot be sold without buying or renting somewhere else, which makes it a consumption asset with an investment attached rather than an investment, and treating it as the latter distorts every other decision in the portfolio.",
  ...
  "whenToUse": "When calculating net worth for any planning purpose, and before assuming the home forms part of a retirement plan. Also before buying a second property, when the concentration question becomes live.",
  "sources": [
    {
    ...
    {
      "name": "Bank for International Settlements, residential property price statistics",
