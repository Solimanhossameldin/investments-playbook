...
{
  "order": 47,
  "slug": "residency-and-tax",
  "title": "Residency, and the tax that follows you",
  "category": "tax",
  "tier": 1,
  "calculator": "estate-tax-exposure",
  "reviewed": "28 August 2026",
  "summary": "Moving to a country with no income tax removes the tax charged by the place you live, and leaves untouched every tax charged by the place an asset sits, the country whose passport you hold, or the country a fund is domiciled in, which is where the surprises come from.",
  "formula": "Four separate questions, answered separately\n\n  1. Residence   where do you live for tax purposes?\n                 usually a day count plus a ties test\n  2. Source      where does the income arise?\n                 rent is taxed where the building is, almost always\n  3. Situs       where is the asset located for death duties?\n                 not the same test as source\n  4. Citizenship does your passport tax you regardless?\n                 the United States says yes\n\nWhat leaving actually removes\n  Residence-based tax on worldwide income:  removed\n  Source-based tax on foreign assets:        unchanged\n  Situs-based estate tax:                    unchanged\n  Citizenship-based tax:                     unchanged\n\nThe day count is necessary, not sufficient\n  Days below the threshold does not equal non-resident\n  if the ties remain: a home available to you, a family\n  there, a business, memberships. Ties tests decide the\n  cases people get wrong.",
  "failureModes": [
  ...
  "whenToUse": "Before the move rather than after, because the departure year is the one with the exit charges and the split-year rules in it. Then again whenever an asset is bought in a country you do not live in, which restarts the source and situs questions.",
  "sources": [
    {
      "name": "UAE Federal Tax Authority, corporate tax",
      "url": "https://tax.gov.ae/en/taxes/corporate.tax.aspx"
    },
    {
      "name": "IRS, nonresidents with US assets and estate tax returns",
    ...
    {
      "name": "UK government, tax on UK income while living abroad",
      "url": "https://www.gov.uk/tax-uk-income-live-abroad/rent"
    },
    {
      "name": "IMF, Annual Report on Exchange Arrangements and Exchange Restrictions",
...
**This is the framework in the library that most needs a professional attached to it.** The questions above are the ones to arrive with. The answers depend on two countries' rules, any treaty between them, and facts specific to you, and a page cannot supply those. [Wills and succession in the UAE](/playbooks/uae-wills-and-succession/) is the companion piece for what happens to the assets afterwards, and it has the same warning on it.
